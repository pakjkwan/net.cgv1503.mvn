            ...
            <!-- 그림출력부분 -->
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78110">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78110/78110_185.jpg" alt="채피 포스터" onerror="errorImage(this)"/>
                    ...
                    <div class="box-contents">
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78110">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>5,717</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span>
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20007131&MOVIE_CD_GROUP=20007131">예매</a>
                        </span>
                    </div>    
                </li>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78042">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78042/78042_185.jpg" alt="킹스맨: 시크릿 에이전트 포스터" onerror="errorImage(this)"/>
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=78042">
                            <strong class="title">킹스맨: 시크릿 에이전트</strong>
                        </a>

                        <div class="score">
                            <strong class="percent">예매율<span>17.5%</span></strong>
                            <div class="point">
                                <em>9.0</em>
                            </div>
                        </div>
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78042">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>21,453</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span>
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20006917&MOVIE_CD_GROUP=20006917">예매</a>
                        </span>
                    </div>    
                </li>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78085">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78085/78085_185.jpg" alt="위플래쉬 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-15">15세 이상</span>
                            </span>
                    ...
                    <div class="box-contents">
                        ...
                        <div class="score">
                            <strong class="percent">예매율<span>16.5%</span></strong>
                            <div class="point">
                                <em>9.1</em>
                            </div>
                        </div>
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78085">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>7,023</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span>
                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20006850&MOVIE_CD_GROUP=20006850">예매</a>
                        </span>
                    </div>    
                </li>
            ...
            <ol>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78073">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78073/78073_185.jpg" alt="살인의뢰 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-19">청소년 관람불가</span>
                            </span>
                        </a>
                        <span class="screentype">
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=78073">
                            <strong class="title">살인의뢰</strong>
                        </a>

                        <div class="score">
                            <strong class="percent">예매율<span>15.3%</span></strong>
                            <div class="point">
                                <em>7.4</em>
                            </div>
                        </div>
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78073">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>5,730</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span> 

                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20007124&MOVIE_CD_GROUP=20007124">예매</a>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78107">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78107/78107_185.jpg" alt="소셜포비아 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-15">15세 이상</span>
                            </span>
                        </a>
                        <span class="screentype">
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=78107">
                            <strong class="title">소셜포비아</strong>
                        </a>

                        <div class="score">
                            <strong class="percent">예매율<span>10.7%</span></strong>
                            <div class="point">
                                <em>8.1</em>
                            </div>
                        </div>
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78107">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>6,071</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span> 

                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20007044&MOVIE_CD_GROUP=20007044">예매</a>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78092">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78092/78092_185.jpg" alt="이미테이션 게임 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-15">15세 이상</span>
                            </span>
                        </a>
                        <span class="screentype">
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=78092">
                            <strong class="title">이미테이션 게임</strong>
                        </a>
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78092">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>14,558</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span> 

                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20006967&MOVIE_CD_GROUP=20006967">예매</a>
                ...
                <li>
                    <div class="box-image" >
                        ...
                        <a href="/movies/detail-view/?midx=78072">
                            <span class="thumb-image">
                                <img src="http://img.cgv.co.kr/Movie/Thumbnail/Poster/000078/78072/78072_185.jpg" alt="헬머니 포스터" onerror="errorImage(this)"/>
                                <span class="ico-grade grade-19">청소년 관람불가</span>
                            </span>
                        </a>
                        <span class="screentype">
                    ...
                    <div class="box-contents">
                        <a href="/movies/detail-view/?midx=78072">
                            <strong class="title">헬머니</strong>
                        </a>

                        <div class="score">
                            <strong class="percent">예매율<span>2.2%</span></strong>
                            <div class="point">
                                <em>7.9</em>
                            </div>
                        </div>
                        ...
                        <span class="like"> 
                            <button class="btn-like" value="78072">영화 찜하기</button>
                            <span class="count"> 
                                <strong><i>3,202</i><span>명이 선택</span></strong> 
                                <i class="corner-RT"></i><i class="corner-LT"></i><i class="corner-LB"></i><i class="corner-RB"></i><i class="corner-arrow"></i>
                            </span> 

                            <a class="link-reservation" href="/ticket/?MOVIE_CD=20007093&MOVIE_CD_GROUP=20007093">예매</a>
