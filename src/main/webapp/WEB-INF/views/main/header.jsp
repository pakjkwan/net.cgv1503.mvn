...
<div class="head">	
			<h1><a href="main.do" onclick="setClickLog('/메인/GNB/로고');"><img src="./resources/img/h1_cgv.png" alt="CGV" /></a></h1>
			<div class="sect-service">
				...
				<c:when test="${email eq null or email eq ''}">
					<ul style='list-style-type:none'>
	                	<!-- 관리자 로그인 성공시 onclick="setClickLog('/GNB/로그인');-->
					...
					<li style='display:inline'><a href="guest_list.do"> 방명록 | </a></li>
					<li style='display:inline'><a href="${context }/about.do"> 회사소개 | </a></li>
					<!-- <li><font>기본 조건</font> </li> -->
					</ul>
					
				</c:when>	
				
				<c:when test="${email eq 'admin@cho.net'}">
				
					<ul style='list-style-type:none'>
	                	<!-- 관리자 로그인 성공시 onclick="setClickLog('/GNB/로그인');-->
	                    <li style='display:inline'><a href="login_page.do" ><span> 로그아웃 | </span></a></li>
						<li style='display:inline'><a href="javascript:alert('준비중입니다 ^^;');"><span> 마이페이지 | </span></a></li>
	                    <li style='display:inline'><a href="board_form.do"> 게시판 | </a></li>
						<li style='display:inline'><a href="guest_list.do"> 방명록 | </a></li>
						<li style='display:inline'><a href="${context }/admin.do" > 관리자 | </a></li>
						<li style='display:inline'><a href="${context }/about.do"> 회사소개 | </a> <c:out value="${'관리자'}" />
							 <c:out value="${email}" />  </li>
						<%-- <li> <c:out value="${'관리자'}" />
							 <c:out value="${email}" /> </li> --%>
					</ul>
				</c:when>
				<c:when test="${email ne 'admin@cho.net'}">
				
					<ul style='list-style-type:none'>
	                	<!-- 일반멤버 로그인 성공시 onclick="setClickLog('/GNB/로그인');-->
	                    <li style='display:inline'><a href="login_page.do" ><span> 로그아웃 | </span></a></li>
						<li style='display:inline'><a href="javascript:alert('준비중입니다 ^^;');" ><span> 마이페이지 | </span></a></li>
	                    <li style='display:inline'><a href="board_form.do"> 게시판 | </a></li>
						<li style='display:inline'><a href="guest_list.do"> 방명록 | </a></li>
						<li style='display:inline'><a href="${context }/about.do"> 회사소개 | </a> <c:out value="${'일반유저'}" />
							<c:out value="${email}" /></li>
            ...
            <div class="im-wrap"> <!-- Important wrap -->
							...
							<div class="sub-wrap">
								...
								<div class="smenu">
									<ul>
										...
										<li class="last"><a href="/arthouse/" onclick="#;">CGV아트하우스</a></li>
									</ul>
								</div>
							</div>
						</li>
				...
				<div class="ad-partner">
                    <a href="#"  onclick="setClickLog('/GNB/제휴배너(검색)');">
